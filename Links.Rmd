...
-   You can download the R-script [here](files/CWIDM_practicum_2_script%20(2).R?raw=true).

-   You can download the assignment script and output (R-markdown) [here](Practicum_2_markdown.Rmd).
